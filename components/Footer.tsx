            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <CalendlyButton className="inline-block px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700">
                            Book Consultation
                        </CalendlyButton>
                    </div>
                </div>
                ...
                <div className="border-t border-slate-800 pt-8 text-center text-gray-400 text-sm">
                    <p>&copy; {new Date().getFullYear()} MetaMinds STEM Academy. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
