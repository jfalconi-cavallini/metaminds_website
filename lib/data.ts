export const siteData = {
    ...
    pricing: {
        ...
        competitors: [
            { name: "Revolution Prep", pricePerHour: "$200+/hr", type: "Corporate tutoring company" },
            { name: "Princeton Review", pricePerHour: "$200+/hr", type: "Large franchise model" },
            { name: "TKO Prep", pricePerHour: "$200+/hr", type: "Premium test prep service" },
        ],
        differentiators: [
            ...
            "Same elite credentials: B.S. & M.S. from UC San Diego and UC Berkeley",
    ...
    founders: [
        ...
        },
        {
            ...
            credentials: [
                "B.S. Mathematics–Computer Science, UC San Diego, M.S. Business Analytics, Georgia Tech",
                "MBA , Georgia Institute of Technology",
                "Former robotics instructor at Magikid Robotics Lab",
                "Professional tutor at EdLadder",
            ],
            bio: "Christian holds a B.S. in Mathematics–Computer Science and an M.S. in Business Analytics from Georgia Tech, and is currently pursuing his MBA at Georgia Tech. He specializes in mathematics, programming, and data-driven problem solving, helping students build strong analytical and coding skills grounded in both engineering and business.",
        },
    ],
